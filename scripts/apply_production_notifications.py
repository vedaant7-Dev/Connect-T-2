...
notification_manager = r'''import Constants from "expo-constants";
...
write("backend/notificationSystemPatch.js", backend_patch)
write("mobile/components/NotificationManager.tsx", notification_manager)

replace_once(
    "backend/productionBootstrap.js",
...
replace_once(
    "mobile/app.json",
    '      "expo-media-library",\n',
    '      "expo-media-library",\n      [\n        "expo-notifications",\n        {\n          "color": "#16A34A",\n          "defaultChannel": "connectt-updates"\n        }\n      ],\n',
)

replace_once(
    "mobile/app/super-admin/settings.tsx",
...
print("PRODUCTION_NOTIFICATIONS_V108 applied")
