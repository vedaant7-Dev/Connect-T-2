        ...
        <View style={{ flex: 1, backgroundColor: "rgba(15,23,42,0.55)", justifyContent: "flex-end" }}>
          <View style={{ maxHeight: "88%", backgroundColor: "white", borderTopLeftRadius: 26, borderTopRightRadius: 26, paddingTop: 8 }}>
            ...
            <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: Math.max(insets.bottom, 18) + 12 }} keyboardShouldPersistTaps="handled">
              ...
              <TextInput value={title} onChangeText={setTitle} placeholder="Title (optional)" placeholderTextColor="#0F172A" maxLength={255} style={{ minHeight: 50, borderRadius: 14, borderWidth: 1, borderColor: "#E2E8F0", backgroundColor: "#F8FAFC", paddingHorizontal: 13, color: "#0F172A", fontFamily: "Inter_500Medium", fontSize: 13, marginBottom: 10 }} />
              <TextInput value={content} onChangeText={setContent} placeholder="Write the complete message here" placeholderTextColor="#0F172A" multiline maxLength={5000} textAlignVertical="top" style={{ minHeight: 130, borderRadius: 14, borderWidth: 1, borderColor: "#E2E8F0", backgroundColor: "#F8FAFC", padding: 13, color: "#0F172A", fontFamily: "Inter_400Regular", fontSize: 13, lineHeight: 20, marginBottom: 12 }} />
