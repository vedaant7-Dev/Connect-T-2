...
export default function NewAlertScreen() {
  ...
  const [validTo, setValidTo] = useState(
    new Date(Date.now() + ALERT_ACTIVE_MS).toISOString().split("T")[0],
  );
  ...
  const pickMedia = async () => {
    ...
    if (
      ...
      asset.duration > MAX_VIDEO_MS
    ) {
      showMessage(
        "Video too long",
        "Please select a video of 2 minutes or less.",
      );
      return;
    }
  ...
  const submit = () => {
    ...
    addAlert(
      ...
      user?.id,
      targetAudience === "Ward residents" ? user?.ward : undefined,
    );
    router.back();
  };
      ...
      >
        <View style={styles.card}>
          ...
          <View style={styles.segmentRow}>
            {(["alert", "news"] as AlertType[]).map((item) => {
              ...
              return (
                ...
                >
                  <Feather
                    name={item === "alert" ? "alert-triangle" : "radio"}
                    size={16}
                    color={active ? color : "#94A3B8"}
                  />
                  <Text style={[styles.segmentText, active && { color }]}>
                    {item === "alert" ? "Alert" : "News"}
                  </Text>
                </TouchableOpacity>
              );
            })}
          ...
          <View style={styles.chipRow}>
            {(["normal", "important", "urgent"] as AlertPriority[]).map(
              (item) => (
                <TouchableOpacity
                  key={item}
                ...
                >
                  <Text
                    style={[
                      styles.chipText,
                      priority === item && styles.chipTextActive,
                    ]}
                  >
                    {item}
                  </Text>
        ...
        <View style={styles.card}>
          ...
          <TextInput
            ...
            placeholder="Explain what happened, affected area, timing, and citizen instructions..."
            placeholderTextColor="#CBD5E1"
            multiline
          ...
          <View style={styles.twoCol}>
            ...
            <TextInput
              ...
              placeholder="Phone number or office contact"
              placeholderTextColor="#CBD5E1"
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.helperText}>
              Attach one photo or one video. Videos must be 2 minutes or less.
            </Text>
            {media ? (
              ...
              >
                ...
                <Text style={styles.uploadSub}>
                  Photo JPG/PNG or video up to 2 minutes
                </Text>
              </TouchableOpacity>
            )}
          </View>
