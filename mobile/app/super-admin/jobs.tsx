...
export default function JobsAdminScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F0F4F8" }}>
      ...
      <AppScrollView onAppRefresh={refreshJobs} style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 12, paddingTop: 0, paddingBottom: 36 }} showsVerticalScrollIndicator={false}>
        <>
