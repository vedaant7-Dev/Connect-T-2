...
const styles = StyleSheet.create({
  ...
  chatInputCard: { flex: 1, flexDirection: "row", alignItems: "center", backgroundColor: "white", borderRadius: 22, paddingLeft: 16, paddingRight: 6, paddingVertical: 6, minHeight: 42, maxHeight: 110, shadowColor: "#EA580C", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 6, elevation: 2 },
  chatInput: { flex: 1, fontSize: 15, color: "#1C1917", fontFamily: "Inter_400Regular", lineHeight: 20, padding: 0, margin: 0, outlineWidth: 0 } as any,
